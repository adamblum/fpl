class PlayerGamesController < ApplicationController
  ...
  private
    ...
    def player_game_params
      params.require(:player_game).permit(:player_id, :position, :team, :cost, :point_last_round, :total_points, :average_points, :yellow_cards, :transfers_out, :yellow_cards, :goals_scored, :saves, :value_season, :transfers_out, :price_rise, :last_season_points, :value_form, :penalties_missed, :form, :bonus, :selected_by_percent, :transfers_in, :minutes_played, :transfers_in_round, :red_cards, :bps, :forecast)
    end
end
